...
| Ashigaru 1-5 | Configurable (see settings.yaml) | multiagent:0.1-0.5 | Implementation |
| Metsuke | Configurable | multiagent:0.6 | Spec management |
| Kenshi | Configurable | multiagent:0.7 | Test management |
| Gunshi | Opus | multiagent:0.8 | Strategic thinking |

**Default: Assign implementation to ashigaru.** Route strategy/analysis to Gunshi (Opus). Route spec work to Metsuke. Route testing to Kenshi.
