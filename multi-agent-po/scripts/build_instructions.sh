...
build_instruction_file "claude" "kenshi" "kenshi.md"
...
build_instruction_file "codex" "kenshi" "codex-kenshi.md"
...
build_instruction_file "copilot" "kenshi" "copilot-kenshi.md"
...
build_instruction_file "kimi" "kenshi" "kimi-kenshi.md"
...
generate_agents_md() {
    ...
    sed \
        ...
        -e 's|instructions/kenshi\.md|instructions/generated/codex-kenshi.md|g' \
        -e 's|~/.claude/|~/.codex/|g' \
...
generate_copilot_instructions() {
    ...
    sed \
        ...
        -e 's|instructions/kenshi\.md|instructions/generated/copilot-kenshi.md|g' \
...
generate_kimi_instructions() {
    ...
    sed \
        ...
        -e 's|instructions/kenshi\.md|instructions/generated/kimi-kenshi.md|g' \
        -e 's|~/.claude/|~/.kimi/|g' \
