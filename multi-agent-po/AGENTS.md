...
3. **Read your instructions file**: shogun→`instructions/generated/codex-shogun.md`, karo→`instructions/generated/codex-karo.md`, ashigaru→`instructions/generated/codex-ashigaru.md`, gunshi→`instructions/generated/codex-gunshi.md`, metsuke→`instructions/generated/codex-metsuke.md`, kenshi→`instructions/generated/codex-kenshi.md`. **NEVER SKIP** — even if a conversation summary exists. Summaries do NOT preserve persona, speech style, or forbidden actions.
...
## /new Recovery (ashigaru/gunshi/metsuke/kenshi only)
